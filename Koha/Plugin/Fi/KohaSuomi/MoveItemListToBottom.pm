package Koha::Plugin::Fi::KohaSuomi::MoveItemListToBottom;
...
our $metadata = {
    name            => "IntranetUserJS: Move item list to bottom on modify",
    author          => 'Lari Strand',
    date_authored   => '2024-10-01',
    date_updated    => '2024-10-01',
    minimum_version => '23.11',
    maximum_version => '',
    version         => $VERSION,
    description     => "Siirtää nidelistan sivun loppuun niteen muokkauksessa",
};
...
sub intranet_js {
    ...
    my $plugin_fulldir = $dir . "/Koha/Plugin/Fi/KohaSuomi/MoveItemListToBottom/";
